...
private val sky = mapOf(
    ...
    "PARTLY_CLOUDY_DAY" to Sky("partly cloudy", R.drawable.ic_partly_cloud_day, R.drawable.bg_partly_cloudy_day),
    ...
    "WIND" to Sky("wind", R.drawable.ic_cloudy, R.drawable.bg_cloudy),
    ...
    "DUST" to Sky("cloudy", R.drawable.ic_fog, R.drawable.bg_fog),
    )
